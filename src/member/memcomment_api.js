...
router.get("/", async (req, res) => {
  console.log(1)
  const sql = "SELECT order_evaluations.*, products.title,products.image_path FROM order_evaluations LEFT JOIN products ON order_evaluations.product_id = products.id WHERE customer_id = ?";
